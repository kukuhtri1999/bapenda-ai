    ...
    <div class="floating-chat">
        ...
        >
            ...
            <div ref="messagesContainer" class="messages-container">
                ...
                >
                    ...
                    <h3 class="text-h6 mb-2 gradient-text font-weight-bold">
                        Halo! 👋
                    </h3>
                    <p
                        class="text-body-2 text-grey-700 mb-4"
                        style="line-height: 1.6"
                    >
                        Saya siap membantu Anda dengan informasi layanan Samsat
                        Lamongan
                    </p>

                    <!-- Quick Suggestions -->
                    <div class="mb-4">
                        <p class="text-caption text-grey-600 mb-3">
                            Pertanyaan populer:
                        </p>
            ...
            >
                <v-row no-gutters align="center" class="gap-3">
                    <v-col>
                        <v-textarea
        ...
        >
            <v-card-text class="pa-3 text-center">
                <v-icon color="white" size="24" class="mb-1">mdi-robot</v-icon>
                <p class="text-caption text-white mb-0 font-weight-medium">
                    Chat
                </p>
                <v-badge
                    v-if="unreadCount > 0"
