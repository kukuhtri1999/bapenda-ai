    ...
    <div class="pa-0">
                  ...
                  >
                    <VCardText class="pa-4">
                      <div class="d-flex align-center mb-3">
                        <VAvatar :color="step.color" size="32" class="mr-3">
      ...
      <VRow class="mb-6">
        <VCol cols="12">
          <VCard elevation="2">
            <VCardTitle
              class="d-flex align-center bg-gradient-to-r bg-purple-600 text-white"
            >
                    ...
                    <div class="prose max-w-none">
                      ...
                      <VRow class="mb-6">
                        <VCol cols="12" md="4">
                          <VCard variant="outlined" class="text-center pa-4">
                            <VIcon color="primary" size="48" class="mb-2"
                              >mdi-database</VIcon
                            >
                        ...
                        <VCol cols="12" md="4">
                          <VCard variant="outlined" class="text-center pa-4">
                            <VIcon color="success" size="48" class="mb-2"
                        ...
                        <VCol cols="12" md="4">
                          <VCard variant="outlined" class="text-center pa-4">
                            <VIcon color="warning" size="48" class="mb-2"
                      ...
                      <div class="rich-content">
                        ...
                        <p class="text-body-1 mb-4">
                          Our AI-powered knowledge base system demonstrates
                          <strong class="text-success"
                            >robust operational capabilities</strong
                          >
                          with comprehensive content coverage across multiple
                          service categories. The current deployment shows
                          <strong>high content quality</strong> and
                          <strong>effective categorization</strong> supporting
                          enhanced user experience through intelligent search
                        ...
                        <p class="text-body-1 mb-4">
                          Content analysis reveals strategic alignment with
                          organizational priorities, featuring
                          <em>balanced coverage</em> across service domains. The
                          vector database integration ensures
                          <strong class="text-primary"
                            >semantic search capabilities</strong
                          >
                          that significantly improve query resolution accuracy
                        ...
                        <p class="text-body-1 mb-4">
                          ...
                          <code class="bg-grey-lighten-4 pa-1 rounded"
                            >Retrieval-Augmented Generation (RAG)</code
                          >
                          technology positions the system at the forefront of
                          AI-driven public service delivery. This approach
                          combines the reliability of curated knowledge with the
                          flexibility of large language models, creating a
                          <strong class="text-accent"
                            >dynamic and responsive</strong
                          >
                          information system.
                        </p>
                        ...
                        <VAlert type="info" variant="outlined" class="mt-4">
                          ...
                          Continue expanding content coverage while maintaining
                          quality standards. The current trajectory supports
                          scalable growth and enhanced service delivery
                          capabilities.
                        </VAlert>
                      </div>
                    </div>
                ...
                <VTabsWindowItem value="performance">
                  <div class="pa-6">
                    ...
                    <VAlert type="success" variant="outlined">
                      ...
                      All key performance indicators exceed industry standards,
                      demonstrating system reliability and efficiency.
                    </VAlert>
                  </div>
                </VTabsWindowItem>
