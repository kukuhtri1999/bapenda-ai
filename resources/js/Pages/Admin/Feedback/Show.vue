        ...
        <VCard class="mb-4">
          ...
          <VCardText class="pa-4">
            ...
            <div class="mb-4">
              ...
              <VAlert v-else type="info" variant="outlined" class="ma-0">
            ...
            <VRow>
              ...
              <VCol cols="12" sm="6">
                <div class="mb-3">
                  ...
                  <div class="text-body-2">
                    {{
                      feedback.chat_session.messages
                        ? feedback.chat_session.messages.length
                        : 'N/A'
                    }}
                  </div>
                </div>
        ...
        <VCard class="mb-4">
          ...
          <VCardText class="pa-4">
            ...
            <div class="mb-3">
              ...
              <div class="text-body-2">
                {{
                  feedback.feedback_text ? feedback.feedback_text.length : 0
                }}
                characters
              </div>
            </div>
...
const exportSingleFeedback = () => {
  ...
  const csvContent = [
    ...
    [
      'Session Started',
      props.feedback.chat_session
        ? formatDateTime(props.feedback.chat_session.created_at)
        : 'N/A',
    ],
  ...
  link.setAttribute(
    'download',
    `feedback_${props.feedback.id}_${Date.now()}.csv`,
  );
