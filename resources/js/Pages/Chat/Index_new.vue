                ...
                <v-col cols="12">
                    ...
                    >
                        ...
                        >
                            ...
                            <h2
                                class="text-h4 mb-4 gradient-text font-weight-bold"
                            >
                            ...
                            <!-- Quick Suggestions -->
                            <div class="mb-6">
                                <h4 class="text-h6 mb-4 text-grey-800">
                                    Pertanyaan Populer:
                                </h4>
                            ...
                            <v-btn
                                ...
                                :style="{
                                    ...
                                    padding: '12px 32px',
                                    boxShadow:
                                        '0 8px 20px rgba(233, 165, 241, 0.4)',
                                }"
                                color="white"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <v-row
                                        ...
                                        no-gutters
                                    >
                                        <v-col cols="auto" class="max-width-70">
                                            <v-card
