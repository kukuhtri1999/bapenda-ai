<template>
    ...
    <v-app>
        <v-container fluid class="pa-0 pt-16 chat-app">
                        ...
                        >
                            <v-avatar
                                ...
                                :style="{
                                    ...
                                    boxShadow:
                                        '0 8px 24px rgba(233, 165, 241, 0.4)',
                                }"
                            >
                            ...
                            <h2
                                class="text-h5 mb-3 gradient-text font-weight-bold"
                            >
                            ...
                            >
                                ...
                                pajak kendaraan, STNK, dan layanan Samsat
                                lainnya 24/7.
                            </p>
                            ...
                            <v-btn
                                ...
                                :style="{
                                    ...
                                    padding: '10px 28px',
                                    boxShadow:
                                        '0 6px 16px rgba(233, 165, 241, 0.4)',
                                }"
                                color="white"
                                ...
                                elevation="0"
                            >
                                <v-icon left size="20">mdi-chat</v-icon>
                                Mulai Chat
                            </v-btn>
                        </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <v-row
                                        ...
                                        class="mb-2"
                                    >
                                        <v-col cols="auto" class="max-width-75">
                                            <v-card
                                                ...
                                                :style="{
                                                    ...
                                                    borderRadius:
                                                        '18px 18px 4px 18px',
                                                    boxShadow:
                                                        '0 3px 10px rgba(233, 165, 241, 0.3)',
                                                    maxWidth: '100%',
                                                }"
                                                elevation="0"
                                            >
                                                <div
                                                    class="text-white font-weight-medium text-body-2"
                                                >
                                                    {{ message.content }}
                                                </div>
                                    ...
                                    <v-row
                                        ...
                                        class="mb-2"
                                    >
                                        <v-col cols="auto" class="max-width-80">
                                    ...
                                    <v-col cols="auto">
                                        <v-btn
                                            ...
                                            :style="{
                                                ...
                                                height: '48px',
                                                boxShadow:
                                                    '0 4px 12px rgba(233, 165, 241, 0.3)',
                                            }"
                                            class="text-white"
                                            elevation="0"
                                            icon
                                        >
                                            <v-icon v-if="!isLoading" size="20"
                                                >mdi-send</v-icon
                                            >
                                            <v-progress-circular
                                                v-else
