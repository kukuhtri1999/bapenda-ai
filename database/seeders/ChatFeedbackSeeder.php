...
class ChatFeedbackSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $names = [
            'Budi Santoso', 'Siti Rahayu', 'Ahmad Fauzi', 'Dewi Setyawati', 'Rizki Pratama',
            'Nur Aini', 'Agus Widodo', 'Sri Mulyani', 'Hendra Kurniawan', 'Rina Wulandari',
            'Eko Prasetyo', 'Yuli Astuti', 'Doni Firmansyah', 'Lestari Ningrum', 'Wahyu Sejati',
            'Fitri Handayani', 'Teguh Santoso', 'Mela Puspita', 'Fajar Nugroho', 'Ayu Marlina',
            'Slamet Riyadi', 'Wulan Sari', 'Dimas Arifin', 'Indah Permata', 'Bambang Sugiarto',
            'Retno Kusuma', 'Joko Purnomo', 'Laili Fitriyah', 'Surya Darmawan', 'Nia Rahmawati',
            'Arif Budiman', 'Putri Ramadhani', 'Mahmud Hidayat', 'Suci Wulandari',
        ];
