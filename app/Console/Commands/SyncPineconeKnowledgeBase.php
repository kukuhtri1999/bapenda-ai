...
class SyncPineconeKnowledgeBase extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            if (!$this->confirm('This will completely clear and rebuild the vector database. Continue?')) {
            ...
            if ($currentVectors > 0) {
                ...
                if (!$cleared) {
                    $this->error('Failed to clear vectors');
                    return 1;
                }
                $this->info("✅ Cleared {$currentVectors} vectors");
            } else {
